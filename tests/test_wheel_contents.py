...
hatchling picks it up via ``packages = ["src/sim_plugin_devito"]``
...
def test_wheel_contains_skills(tmp_path: Path) -> None:
    ...
    wheels = list(out_dir.glob("sim_plugin_devito-*.whl"))
    ...
    required = {
        "sim_plugin_devito/__init__.py",
        "sim_plugin_devito/driver.py",
        "sim_plugin_devito/_skills/devito/SKILL.md",
    }
